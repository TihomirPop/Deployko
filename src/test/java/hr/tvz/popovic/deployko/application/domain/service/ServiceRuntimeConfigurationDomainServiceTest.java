...
class ServiceRuntimeConfigurationDomainServiceTest {
    ...
    private static final EnvironmentVariables.Key ENVIRONMENT_VARIABLE_KEY = new EnvironmentVariables.Key("APP_ENV");
    ...
    @Test
    void create_environment_variable_returns_success_when_variable_is_created() {
        ServiceRuntimeConfigurationDomainService service = serviceWithEnvironmentVariableCreator(
                (_, _, _) -> new CreateServiceEnvironmentVariablePort.CreateServiceEnvironmentVariableResult.Created()
        );

        CreateServiceEnvironmentVariableUseCase.CreateServiceEnvironmentVariableResult result =
                service.createServiceEnvironmentVariable(createEnvironmentVariableCommand());

        assertThat(result)
                .isInstanceOf(CreateServiceEnvironmentVariableUseCase.CreateServiceEnvironmentVariableResult.Success.class);
    }

    @Test
    void create_environment_variable_returns_service_not_found_when_service_does_not_exist() {
        ServiceRuntimeConfigurationDomainService service = serviceWithEnvironmentVariableCreator(
                (_, _, _) -> new CreateServiceEnvironmentVariablePort.CreateServiceEnvironmentVariableResult.ServiceNotFound()
        );
        ...
        assertThat(result)
                .isInstanceOf(CreateServiceEnvironmentVariableUseCase.CreateServiceEnvironmentVariableResult.ServiceNotFound.class);
    }

    @Test
    void create_environment_variable_returns_already_exists_when_key_conflicts() {
        ServiceRuntimeConfigurationDomainService service = serviceWithEnvironmentVariableCreator(
                (_, _, _) -> new CreateServiceEnvironmentVariablePort.CreateServiceEnvironmentVariableResult.AlreadyExists()
        );
        ...
        assertThat(result)
                .isInstanceOf(CreateServiceEnvironmentVariableUseCase.CreateServiceEnvironmentVariableResult.AlreadyExists.class);
    }

    @Test
    void create_environment_variable_returns_failure_when_persistence_fails() {
        ServiceRuntimeConfigurationDomainService service = serviceWithEnvironmentVariableCreator(
        ...
        assertThat(result)
                .isInstanceOf(CreateServiceEnvironmentVariableUseCase.CreateServiceEnvironmentVariableResult.Failure.class);
    }

    @Test
    void update_environment_variable_returns_success_when_variable_is_updated() {
        ServiceRuntimeConfigurationDomainService service = serviceWithEnvironmentVariableUpdater(
                (_, _, _) -> new UpdateServiceEnvironmentVariablePort.UpdateServiceEnvironmentVariableResult.Updated()
        );

        UpdateServiceEnvironmentVariableUseCase.UpdateServiceEnvironmentVariableResult result =
                service.updateServiceEnvironmentVariable(updateEnvironmentVariableCommand());

        assertThat(result)
                .isInstanceOf(UpdateServiceEnvironmentVariableUseCase.UpdateServiceEnvironmentVariableResult.Success.class);
    }

    @Test
    void update_environment_variable_returns_service_not_found_when_service_does_not_exist() {
        ServiceRuntimeConfigurationDomainService service = serviceWithEnvironmentVariableUpdater(
                (_, _, _) -> new UpdateServiceEnvironmentVariablePort.UpdateServiceEnvironmentVariableResult.ServiceNotFound()
        );
        ...
        assertThat(result)
                .isInstanceOf(UpdateServiceEnvironmentVariableUseCase.UpdateServiceEnvironmentVariableResult.ServiceNotFound.class);
    }

    @Test
    void update_environment_variable_returns_variable_not_found_when_key_does_not_exist() {
        ServiceRuntimeConfigurationDomainService service = serviceWithEnvironmentVariableUpdater(
                (_, _, _) -> new UpdateServiceEnvironmentVariablePort.UpdateServiceEnvironmentVariableResult.EnvironmentVariableNotFound()
        );
        ...
        assertThat(result)
                .isInstanceOf(UpdateServiceEnvironmentVariableUseCase.UpdateServiceEnvironmentVariableResult.EnvironmentVariableNotFound.class);
    }

    @Test
    void update_environment_variable_returns_failure_when_persistence_fails() {
        ServiceRuntimeConfigurationDomainService service = serviceWithEnvironmentVariableUpdater(
        ...
        assertThat(result)
                .isInstanceOf(UpdateServiceEnvironmentVariableUseCase.UpdateServiceEnvironmentVariableResult.Failure.class);
    }

    @Test
    void delete_environment_variable_returns_success_when_variable_is_deleted() {
        ServiceRuntimeConfigurationDomainService service = serviceWithEnvironmentVariableDeleter(
                (_, _) -> new DeleteServiceEnvironmentVariablePort.DeleteServiceEnvironmentVariableResult.Deleted()
        );

        DeleteServiceEnvironmentVariableUseCase.DeleteServiceEnvironmentVariableResult result =
                service.deleteServiceEnvironmentVariable(deleteEnvironmentVariableCommand());

        assertThat(result)
                .isInstanceOf(DeleteServiceEnvironmentVariableUseCase.DeleteServiceEnvironmentVariableResult.Success.class);
    }

    @Test
    void delete_environment_variable_returns_service_not_found_when_service_does_not_exist() {
        ServiceRuntimeConfigurationDomainService service = serviceWithEnvironmentVariableDeleter(
                (_, _) -> new DeleteServiceEnvironmentVariablePort.DeleteServiceEnvironmentVariableResult.ServiceNotFound()
        );
        ...
        assertThat(result)
                .isInstanceOf(DeleteServiceEnvironmentVariableUseCase.DeleteServiceEnvironmentVariableResult.ServiceNotFound.class);
    }

    @Test
    void delete_environment_variable_returns_variable_not_found_when_key_does_not_exist() {
        ServiceRuntimeConfigurationDomainService service = serviceWithEnvironmentVariableDeleter(
                (_, _) -> new DeleteServiceEnvironmentVariablePort.DeleteServiceEnvironmentVariableResult.EnvironmentVariableNotFound()
        );
        ...
        assertThat(result)
                .isInstanceOf(DeleteServiceEnvironmentVariableUseCase.DeleteServiceEnvironmentVariableResult.EnvironmentVariableNotFound.class);
    }

    @Test
    void delete_environment_variable_returns_failure_when_persistence_fails() {
        ServiceRuntimeConfigurationDomainService service = serviceWithEnvironmentVariableDeleter(
        ...
        assertThat(result)
                .isInstanceOf(DeleteServiceEnvironmentVariableUseCase.DeleteServiceEnvironmentVariableResult.Failure.class);
    }
    ...
    private static ServiceRuntimeConfigurationDomainService serviceWithEnvironmentVariableCreator(
            CreateServiceEnvironmentVariablePort createPort
    ) {
        return new ServiceRuntimeConfigurationDomainService(
                _ -> new FindServiceEnvironmentVariablesPort.FindServiceEnvironmentVariablesResult.Failure(),
                createPort,
    ...
    private static ServiceRuntimeConfigurationDomainService serviceWithEnvironmentVariableUpdater(
            UpdateServiceEnvironmentVariablePort updatePort
    ) {
        return new ServiceRuntimeConfigurationDomainService(
                _ -> new FindServiceEnvironmentVariablesPort.FindServiceEnvironmentVariablesResult.Failure(),
                (_, _, _) -> new CreateServiceEnvironmentVariablePort.CreateServiceEnvironmentVariableResult.Failure(),
    ...
    private static ServiceRuntimeConfigurationDomainService serviceWithEnvironmentVariableDeleter(
            DeleteServiceEnvironmentVariablePort deletePort
    ) {
        return new ServiceRuntimeConfigurationDomainService(
                _ -> new FindServiceEnvironmentVariablesPort.FindServiceEnvironmentVariablesResult.Failure(),
                (_, _, _) -> new CreateServiceEnvironmentVariablePort.CreateServiceEnvironmentVariableResult.Failure(),
    ...
    private static CreateServiceEnvironmentVariableUseCase.CreateServiceEnvironmentVariableCommand createEnvironmentVariableCommand() {
        return new CreateServiceEnvironmentVariableUseCase.CreateServiceEnvironmentVariableCommand(
                SERVICE_NAME,
    ...
    private static UpdateServiceEnvironmentVariableUseCase.UpdateServiceEnvironmentVariableCommand updateEnvironmentVariableCommand() {
        return new UpdateServiceEnvironmentVariableUseCase.UpdateServiceEnvironmentVariableCommand(
                SERVICE_NAME,
                ENVIRONMENT_VARIABLE_KEY,
                ENVIRONMENT_VARIABLE_VALUE
        );
    ...
    private static DeleteServiceEnvironmentVariableUseCase.DeleteServiceEnvironmentVariableCommand deleteEnvironmentVariableCommand() {
        return new DeleteServiceEnvironmentVariableUseCase.DeleteServiceEnvironmentVariableCommand(
                SERVICE_NAME,
                ENVIRONMENT_VARIABLE_KEY
        );
    }
